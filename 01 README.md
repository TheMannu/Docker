...
## Understanding Docker the terminology (Inspired from Docker Docs)
...
## What is a container ?
### Learn Docker Container with examples.
...
```
git clone https://github.com/TheMannu/Docker.git
cd  Examples
```
...
```
docker build -t Themannu/my-first-docker-image:latest .
```
...
```
    ...
    Successfully tagged Themannu/my-first-docker-image:latest
```
...
Themannu/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it Themannu/my-first-docker-image
```
...
```
docker push Themannu/my-first-docker-image
```
...
The push refers to repository [docker.io/Themannu/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
